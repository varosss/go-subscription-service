...
const docTemplate = `{
        ...
        "/subscriptions": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Start date filter (MM-YYYY)",
                        "name": "from_date",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "End date filter (MM-YYYY)",
                        "name": "to_date",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.CreateSubRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/http.CreateSubResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/subscriptions/total-cost": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Start of period, format MM-YYYY, defaults to start of current month",
                        "name": "from_date",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "End of period, format MM-YYYY, defaults to end of current month",
                        "name": "to_date",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.CalculateTotalCostResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.UpdateSubRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "http.CalculateTotalCostResponse": {
            "type": "object",
            "properties": {
                "from_date": {
                    "type": "string",
